...
A data analyst with experience in software development, I work across the full data lifecycle — including data identification, collection, cleansing, statistical analysis, automation of financial processes, dynamic reporting, scalable data pipelines, and ETL workflows. I develop and implement AI agents, organize enterprise data using BI and cloud-based tools, and structure operational workflows that support accurate and efficient decision-making. I`m organized and focused on improving processes through the practical application of technology and data.
